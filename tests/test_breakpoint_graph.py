...
class BreakpointGraphTestCase(unittest.TestCase):
    ...
    def test_add_edge_without_multicolor(self):
        with self.assertRaises(TypeError):
            BreakpointGraph().add_edge(vertex1=OldBGVertex("v1"), vertex2=OldBGVertex("v2"))
    ...
    def test_apply_kbreak_incorrect_invalid_kbreak(self):
        ...
        bg = BreakpointGraph()
        v1, v2, v3, v4 = OldBGVertex("v1"), OldBGVertex("v2"), OldBGVertex("v3"), OldBGVertex("v4")
    ...
    def test_apply_kbreak_incorrect_non_existing_single_start_infinity_vertex(self):
        ...
        bg = BreakpointGraph()
        v1, v2, v3 = OldBGVertex("v1"), OldBGVertex("v2"), OldBGVertex("v3")
        iv1 = OldBGVertex.construct_infinity_vertex_companion(v1)
        multicolor = Multicolor(self.genome2)
        bgedge1 = BGEdge(vertex1=v1, vertex2=v2, multicolor=multicolor)
    ...
    def test_apply_kbreak_correct_no_infinity_vertices(self):
        ...
        v1, v2, v3, v4, v5, v6 = (OldBGVertex(name) for name in names)
        multicolor = Multicolor(self.genome2)
        bgedge1 = BGEdge(vertex1=v1, vertex2=v2, multicolor=multicolor)
        bgedge2 = BGEdge(vertex1=v3, vertex2=v4, multicolor=multicolor)
    ...
    def test_apply_kbreak_correct_paired_infinity_vertices(self):
        ...
        i_v1, i_v2 = OldBGVertex.construct_infinity_vertex_companion(v1), OldBGVertex.construct_infinity_vertex_companion(v2)
        multicolor = Multicolor(self.genome2)
        bgedge1 = BGEdge(vertex1=v1, vertex2=v2, multicolor=multicolor)
        bg.add_bgedge(bgedge1)
        ...
        bg.apply_kbreak(kbreak=kbreak)
        ref_edges = [BGEdge(vertex1=vertex1, vertex2=vertex2, multicolor=multicolor) for vertex1, vertex2 in end_edges
                     if not (OldBGVertex.is_infinity_vertex(vertex1) and OldBGVertex(vertex2))]
        res_edges = []
        for vertex1, vertex2 in end_edges:
        ...
        bg = BreakpointGraph()
        v1, v2, v3 = OldBGVertex("v1"), OldBGVertex("v2"), OldBGVertex("v3")
        i_v1, i_v2, i_v3 = [OldBGVertex.construct_infinity_vertex_companion(vertex) for vertex in (v1, v2, v3)]
        multicolor = Multicolor(self.genome2)
        multicolor2 = Multicolor(self.genome4)
        bgedge1 = BGEdge(vertex1=v1, vertex2=i_v1, multicolor=multicolor)
        ...
        ref_edges = [BGEdge(vertex1=vertex1, vertex2=vertex2, multicolor=multicolor) for vertex1, vertex2 in end_edges
                     if not (OldBGVertex.is_infinity_vertex(vertex1) and OldBGVertex.is_infinity_vertex(vertex2))]
        res_edges = []
        for vertex1, vertex2 in end_edges:
            if OldBGVertex.is_infinity_vertex(vertex1) and OldBGVertex.is_infinity_vertex(vertex2):
                continue
    ...
    def test_json_deserialization(self):
        ...
        class BGVertexJSONShcemaWithSpecialAttribute(OldBGVertex.BGVertexJSONSchema):
